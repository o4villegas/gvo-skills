---
name: review-hunter
description: Dynamically pull, aggregate, and analyze customer reviews for any restaurant chain across Google, Yelp, TripAdvisor, and other discoverable sources. Use this skill whenever the user mentions "pull reviews", "review analysis", "review hunter", "what are people saying about [restaurant]", "sentiment analysis for [chain]", "customer feedback for [brand]", "reputation check", "review audit", "reputation dashboard", "review dashboard", "how are our reviews", or any request to find, collect, compare, or summarize online reviews for a restaurant, bar, café, or food/beverage chain. Also trigger when the user names a restaurant brand and asks about customer perception, complaints, praise patterns, location-level review differences, competitive positioning via reviews, owner response rates, or review trends over time. Even casual phrasing like "how's [chain] doing on Google reviews", "check Yelp for [brand]", "are people happy with [chain]", "what's our rating", or "build me a review report" should trigger this skill. Trigger for both single-location businesses and multi-location chains. Do NOT trigger for product reviews, app store reviews, or non-food/beverage businesses.
---
